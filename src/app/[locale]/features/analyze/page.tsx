...
export default function AnalyzePage() {
  ...
  const concept = getConceptById('analyze');
  if (!concept) return null;

  const nextConcept = getNextConcept('analyze');
  const previousConcept = getPreviousConcept('analyze');
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              <LineChart className="w-5 h-5" style={{ color: '#002236' }} />
