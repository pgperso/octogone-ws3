    ...
    <>
      ...
      <ResponsiveSection spacing="none" bgColor="" className="py-20">
        ...
        <div className="py-8 px-4" style={{ paddingTop: '3rem' }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 max-w-7xl mx-auto" style={{ rowGap: '2rem' }}>
            {mainPlans.map((plan) => (
        ...
        <div className="py-12 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6" style={{ paddingTop: '0', rowGap: '2rem' }}>
